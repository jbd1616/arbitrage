...
# Read the HTML file
with open('./scraper-out/output_fanduel.html', 'r', encoding='utf-8') as file:
...
df = pd.read_csv('./parser-out/bet365_results.csv')
...
results_df.to_csv("./parser-out/fanduel_results.csv", index=False)
